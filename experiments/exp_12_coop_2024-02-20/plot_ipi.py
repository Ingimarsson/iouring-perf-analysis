...
plt.plot(x, y1, marker = 'o',label = "off IRQ") 
plt.plot(x, y2, marker = 'o',label = "off IRQ COOP") 
plt.plot(x, y3, marker = 'o',label = "on IRQ") 
plt.plot(x, y4, marker = 'o',label = "on IRQ COOP") 
